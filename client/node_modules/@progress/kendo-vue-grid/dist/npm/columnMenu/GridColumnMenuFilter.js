...
exports.GridColumnMenuFilterVue2 = exports.GridColumnMenuFilter = exports.filterGroupByField = exports.rootFilterOrDefault = void 0; // @ts-ignore
...
var GridColumnMenuFilterVue2 = {
  ...
  created: function created() {
    ...
    if (this.$props.column && this.$props.column.field) {
      var filterType = filterCommon_1.getFilterType(this.$props.column.filter);
      var defaultOperator = filterCommon_1.getDefaultOperator(this.$props.filterOperators, filterType);
