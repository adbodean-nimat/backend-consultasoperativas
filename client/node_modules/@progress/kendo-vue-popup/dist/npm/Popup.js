...
var PopupVue2 = {
  ...
  created: function created() {
    ...
    this.reposition = util_1.throttle(this.reposition.bind(this), util_1.FRAME_DURATION);
  },
  // @ts-ignore
  ...
  methods: {
    ...
    calculatePosition: function calculatePosition($props, appendToElement) {
      if (!appendToElement || !util_1.isWindowAvailable() || !kendo_vue_common_1.canUseDOM) {
        return {
          flipped: false,
          offset: $props.offset
        };
  ...
  render: function render(createElement) {
    ...
    var defaultAppentTo = util_1.isWindowAvailable() ? this.$props.appendTo ? this.mountedAppendTo || this.getParentRef(this.$props.appendTo) : document.body : undefined;
