import {
  generarPdfsAvisosDeuda,
  generarPdfsAvisosDeudaRevendedores,
} from "../services/generarAvisos.service.js";
...
export async function procesoEnvioRevendedores() {
  console.log(
    "🚀 Ejecutando envío automático de avisos de deuda para revendedores...",
  );
  try {
