import avisoDeudaTemplate from './src/templates/avisoDeuda.template.js';
import { generarPdfDesdeHtml } from './src/services/pdf.service.js';

async function main() {
    const data = {
        cliente: 92,
        nombre: 'COINAR SRL',
        celular: '5493455281448',
    ...
    const pdfPath = await generarPdfDesdeHtml(html, `aviso-deuda-${data.cliente}.pdf`);
