...
const createTablas = (request, response) => {
  ...
  pool.query(
    "INSERT INTO tablas (nombre_tablas, url_tablas, consultas_tablas) VALUES ($1, $2, $3) RETURNING *",
    [nombre_tablas, url_tablas, consultas_tablas],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const updateTablas = (request, response) => {
  ...
  pool.query(
    ...
    [nombre_tablas, url_tablas, consultas_tablas, id],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const getListadePrecioBUI = (request, response) => {
  pool.query(
    "SELECT * FROM lista_de_precios_breve_uso_interno ORDER BY nro_orden_art ASC",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const getListadePrecioBUIById = (request, response) => {
  ...
  pool.query(
    "SELECT * FROM lista_de_precios_breve_uso_interno WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const createListadePrecioBUI = (request, response) => {
  ...
  pool.query(
    "INSERT INTO lista_de_precios_breve_uso_interno (arts_articulo_emp, arts_nombre, grupo_del_art, comentario, nro_orden_art) VALUES ($1, $2, $3, $4, $5) RETURNING *",
    [arts_articulo_emp, arts_nombre, grupo_del_art, comentario, nro_orden_art],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteListadePrecioBUI = (request, response) => {
  ...
  pool.query(
    "DELETE FROM lista_de_precios_breve_uso_interno WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getMovContenedores = (request, response) => {
  pool.query(
    "SELECT * FROM movimientos_de_contenedores ORDER BY cod_cant_mov ASC",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const getMovContenedoresById = (request, response) => {
  ...
  pool.query(
    "SELECT * FROM movimientos_de_contenedores WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const createMovContenedores = (request, response) => {
  ...
  pool.query(
    "INSERT INTO movimientos_de_contenedores (cod_cant_mov, nombre_movimiento, cant_mov_nro) VALUES ($1, $2, $3) RETURNING *",
    [cod_cant_mov, nombre_movimiento, cant_mov_nro],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const updateMovContenedores = (request, response) => {
  ...
  pool.query(
    ...
    [cod_cant_mov, nombre_movimiento, cant_mov_nro, id],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteMovContenedores = (request, response) => {
  ...
  pool.query(
    "DELETE FROM movimientos_de_contenedores WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getDimensionesCont = (request, response) => {
  pool.query(
    "SELECT * FROM dimensiones_contenedores ORDER BY clas4_clas5 ASC",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const getDimensionesContById = (request, response) => {
  ...
  pool.query(
    "SELECT * FROM dimensiones_contenedores WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const createDimensionesCont = (request, response) => {
  const {
    ...
    medidas_ancho,
    medidas_alto_puerta,
    medidas_alto_interior,
    medidas_largo,
  } = request.body;

  pool.query(
    "INSERT INTO dimensiones_contenedores (clas4_clas5, nombre, medidas_ancho, medidas_alto_puerta, medidas_alto_interior, medidas_largo) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *",
    [
      clas4_clas5,
      nombre,
      medidas_ancho,
...
const deleteDimensionesCont = (request, response) => {
  ...
  pool.query(
    "DELETE FROM dimensiones_contenedores WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getNPaConsiderar = (request, response) => {
  pool.query(
    "SELECT * FROM np_a_considerar ORDER BY id ASC",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const getNPaConsiderarByCod = (request, response) => {
  ...
  pool.query(
    "SELECT * FROM np_a_considerar WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const createNP = (request, response) => {
  ...
  pool.query(
    "INSERT INTO np_a_considerar (cod_comp, nomb_comp) VALUES ($1, $2) RETURNING *",
    [cod_comp, nomb_comp],
    (error, results) => {
      if (error) {
        throw error;
...
const deleteNP = (request, response) => {
  ...
  pool.query(
    "DELETE FROM np_a_considerar WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getDeposANoConsiderar = (request, response) => {
  pool.query(
    "SELECT * FROM depos_a_no_considerar ORDER BY cod_depos ASC",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const getDeposANoConsiderarByCod = (request, response) => {
  ...
  pool.query(
    "SELECT * FROM depos_a_no_considerar WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const deleteDepos = (request, response) => {
  ...
  pool.query(
    "DELETE FROM depos_a_no_considerar WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getConstSecoArmadoConfig1 = (request, response) => {
  pool.query(
    "SELECT * FROM const_seco_armado_config_1 ORDER BY id ASC",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const getConstSecoArmadoConfig1ById = (request, response) => {
  ...
  pool.query(
    "SELECT * FROM const_seco_armado_config_1 WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const deleteConstSecoArmadoConfig1 = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.const_seco_armado_config_1 WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getConstSecoArmadoConfig2 = (request, response) => {
  pool.query(
    "SELECT * FROM public.const_seco_armado_config_2",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const getConstSecoArmadoConfig2ByCod = (request, response) => {
  ...
  pool.query(
    "SELECT * FROM public.const_seco_armado_config_2 WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const deleteConstSecoArmadoConfig2 = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.const_seco_armado_config_2 WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getConstSecoNombresConfig = (request, response) => {
  pool.query(
    "SELECT * FROM public.const_seco_nombres_configuraciones ORDER BY id ASC",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const getConstSecoNombresConfigByCod = (request, response) => {
  ...
  pool.query(
    "SELECT * FROM public.const_seco_nombres_configuraciones WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const deleteConstSecoNombresConfig = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.const_seco_nombres_configuraciones WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getSetsVentasByCod = (request, response) => {
  ...
  pool.query(
    "SELECT * FROM public.sets_de_ventas WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const deleteSetsVentas = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.sets_de_ventas WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getFamiliaArtById = (request, response) => {
  ...
  pool.query(
    "SELECT * FROM public.familias_de_articulos WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const updateFamiliaArt = (request, response) => {
  ...
  pool.query(
    ...
    [id, nombre_fami_art, nro_orden_de_la_fami, set_ventas],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const createFamiliaArt = (request, response) => {
  ...
  pool.query(
    ...
    [nombre_fami_art, nro_orden_de_la_fami, set_ventas],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteFamiliaArt = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.familias_de_articulos WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getVincularArtFamilia = (request, response) => {
  pool.query(
    "SELECT * FROM public.vincular_articulos_a_familia",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const getVincularArtFamiliaByCod = (request, response) => {
  ...
  pool.query(
    "SELECT * FROM public.vincular_articulos_a_familia WHERE cod = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const updateVincularArtFamilia = (request, response) => {
  ...
  pool.query(
    ...
    [cod_art, cod_familia, orden_art_familia, url_imagen, id],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const createVincularArtFamilia = (request, response) => {
  ...
  pool.query(
    ...
    [cod_art, cod_familia, orden_art_familia, url_imagen],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteVincularArtFamilia = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.vincular_articulos_a_familia WHERE cod = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getProductosDistribucion = (request, response) => {
  pool.query(
    "SELECT * FROM public.productos_para_distribucion",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const getProductosDistribucionByCod = (request, response) => {
  ...
  pool.query(
    "SELECT * FROM public.productos_para_distribucion WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const updateProductosDistribucion = (request, response) => {
  const id = parseInt(request.params.id);
  const { Codigo_producto, Orden_producto, Cod_Familia_producto, Url_imagen } =
    request.body;
  ...
  pool.query(
    ...
    [Codigo_producto, Orden_producto, Cod_Familia_producto, id, Url_imagen],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const createProductosDistribucion = (request, response) => {
  ...
  pool.query(
    ...
    [Codigo_producto, Orden_producto, Cod_Familia_producto, Url_imagen],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteProductosDistribucion = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.productos_para_distribucion WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getRubrosVtasByCod = (request, response) => {
  ...
  pool.query(
    "SELECT * FROM public.rubros_ventas WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const updateRubrosVtas = (request, response) => {
  ...
  pool.query(
    ...
    [rubros_id, rubros_nombres, orden_rubros, id],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const createRubrosVtas = (request, response) => {
  ...
  pool.query(
    ...
    [rubros_id, rubros_nombres, orden_rubros],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteRubrosVtas = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.rubros_ventas WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getFamiliaDist = (request, response) => {
  pool.query(
    "SELECT * FROM public.familias_distribuciones",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const updateFamiliaDist = (request, response) => {
  ...
  pool.query(
    ...
    [nombre_familia, orden_familia, id],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteFamiliaDist = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.familias_distribuciones WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getFamArtDist = (request, response) => {
  pool.query(
    "SELECT * FROM public.familias_articulos_distribucion",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const getFamArtDistByCod = (request, response) => {
  ...
  pool.query(
    "SELECT * FROM public.familias_articulos_distribucion WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const deleteFamArtDist = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.familias_articulos_distribucion WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getCartelManualbyId = (request, response) => {
  ...
  pool.query(
    "SELECT * FROM public.cartel_manual WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const updateCartelManual = (request, response) => {
  ...
  pool.query(
    ...
    [titulo, subtitulo, precio, unimed, outlet, id],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const createCartelManual = (request, response) => {
  ...
  pool.query(
    ...
    [titulo, subtitulo, precio, unimed, outlet],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteCartelManual = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.cartel_manual WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getDespositoNoAConsiderarParaStockFisico = (request, response) => {
  pool.query(
    "SELECT * FROM public.depos_a_no_considerar_para_stock_fisico ORDER BY id ASC ",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const updateDespositoNoAConsiderarParaStockFisico = (request, response) => {
  ...
  pool.query(
    ...
    [codigo_deposito, nombre_deposito, id],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const createDespositoNoAConsiderarParaStockFisico = (request, response) => {
  ...
  pool.query(
    ...
    [codigo_deposito, nombre_deposito],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteDespositoNoAConsiderarParaStockFisico = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.depos_a_no_considerar_para_stock_fisico WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const updateCategoriasWeb = (request, response) => {
  ...
  pool.query(
    ...
    [id_categorias, nombre_categorias, id],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const createCategoriasWeb = (request, response) => {
  ...
  pool.query(
    ...
    [id_categorias, nombre_categorias],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteCategoriasWeb = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.categorias WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const deleteArticulosWeb = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.articulos WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const UpdateActualizacionWebCron = (request, response) => {
  const id = parseInt(request.params.id);
  const { actualizacion_cron_lunesaviernes, actualizacion_cron_sabados } =
    request.body;

  pool.query(
    "UPDATE public.actualizacion_web SET id = $1, actualizacion_cron_lunesaviernes = $2, actualizacion_cron_sabados = $3 WHERE id = $1;",
    [id, actualizacion_cron_lunesaviernes, actualizacion_cron_sabados],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const UpdateActualizacionWeb = (request, response) => {
  ...
  const {
    ...
    actualizacion_cron_lunesaviernes,
    actualizacion_cron_sabados,
  } = request.body;
...
const deleteActualizacionWeb = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.actualizacion_web WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getComprobantesAOmitir = (request, response) => {
  pool.query(
    "SELECT * FROM public.comprobantes_a_omitir ",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const updateComprobantesAOmitir = (request, response) => {
  ...
  pool.query(
    ...
    [cod_comprobante, nombre_comprobante, id],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const createComprobantesAOmitir = (request, response) => {
  ...
  pool.query(
    ...
    [cod_comprobante, nombre_comprobante],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteComprobantesAOmitir = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.comprobantes_a_omitir WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const deleteRemitosVtas = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.remitos_de_ventas WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getCalesCementosPlasticor = (request, response) => {
  pool.query(
    "SELECT * FROM public.cales_cementos_plasticor ",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const updateCalesCementosPlasticor = (request, response) => {
  ...
  pool.query(
    ...
    [cod_articulos, nombre_articulos, id],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const createCalesCementosPlasticor = (request, response) => {
  ...
  pool.query(
    ...
    [cod_articulos, nombre_articulos],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteCalesCementosPlasticor = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.cales_cementos_plasticor WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getClientesCtaCte = (request, response) => {
  pool.query(
    "SELECT * FROM public.filtro_clientes_plataforma",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const updateClientesCtaCte = (request, response) => {
  ...
  pool.query(
    ...
    [tipo_de_cliente, perfil_crediticio, id],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const createClientesCtaCte = (request, response) => {
  ...
  pool.query(
    ...
    [tipo_de_cliente, perfil_crediticio],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteClientesCtaCte = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.filtro_clientes_plataforma WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getAcindarClasifClientes = (request, response) => {
  pool.query(
    "SELECT * FROM public.acindar_clasif_clientes",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const createClasifClientes = (request, response) => {
  ...
  pool.query(
    ...
    [clasif_1_ptf, segmento_cliente_acindar, descrip_segmento, observacion],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const updateClasifClientes = (request, response) => {
  ...
  pool.query(
    ...
    [clasif_1_ptf, segmento_cliente_acindar, descrip_segmento, observacion, id],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteClasifClientes = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.acindar_clasif_clientes WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const createAcindarComprobantes = (request, response) => {
  ...
  pool.query(
    ...
    [comprobante_ptf, tipo_de_transaccion, comprobante_acindar, tipo_doc_legal],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteAcindarComprobantes = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.acindar_comprobantes WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getAcindarEquivalCodFactorCant = (request, response) => {
  pool.query(
    "SELECT * FROM public.acindar_equivalcod_factorcant",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const createAcindarEquivalCodFactorCant = (request, response) => {
  ...
  pool.query(
    ...
    [codigo_ptf, codigo_acindar, factor_cant],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const updateAcindarEquivalCodFactorCant = (request, response) => {
  ...
  pool.query(
    ...
    [codigo_ptf, codigo_acindar, factor_cant, id],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteAcindarEquivalCodFactorCant = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.acindar_equivalcod_factorcant WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getFiltroAcindarPTF = (request, response) => {
  pool.query(
    "SELECT * FROM public.acindar_filtro_plataforma",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteFiltroAcindarPTF = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.acindar_filtro_plataforma WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getArtsClasif5AlConsultar = (request, response) => {
  pool.query(
    "SELECT * FROM public.clasif_arts_5_al_consultar",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const updateArtsClasif5AlConsultar = (request, response) => {
  ...
  pool.query(
    ...
    [arts_clasif_5, descripcion, whatsapp, id],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const createArtsClasif5AlConsultar = (request, response) => {
  ...
  pool.query(
    ...
    [arts_clasif_5, descripcion, whatsapp],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteArtsClasif5AlConsultar = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.clasif_arts_5_al_consultar WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const getArtsClasif5StockManual = (request, response) => {
  pool.query(
    "SELECT * FROM public.clasif_arts_5_stock_manual",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const deleteArtsClasif5StockManual = (request, response) => {
  ...
  pool.query(
    "DELETE FROM public.clasif_arts_5_stock_manual WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const gdc_modosdestockminimo = (request, response) => {
  pool.query(
    "SELECT * FROM public.gdc_modosdestockminimo",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gdc_modosdestockminimocreate = (request, response) => {
  ...
  pool.query(
    ...
    [Cod_modo_stock, Nombre_modo_stock],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gdc_modosdestockminimoupdate = (request, response) => {
  ...
  pool.query(
    ...
    [Cod_modo_stock, Nombre_modo_stock, id],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gdc_clasif8artquesecompran = (request, response) => {
  pool.query(
    "SELECT * FROM public.gdc_clasif8artquesecompran",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gdc_clasif8artquesecompranUpdate = (request, response) => {
  ...
  pool.query(
    ...
    [id, Cod_clasif8, Nombre_clasif8, Observacion],
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gdc_deposanoconsiderarparastock = (request, response) => {
  pool.query(
    "SELECT * FROM public.gdc_deposanoconsiderarparastock",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gdc_npstockcompromvtasespecialespendentregaaclientes = (
  request,
  response,
) => {
  pool.query(
    'SELECT * FROM public."gdc_npstockcomprom-vtasespeciales-pendentregaaclientes"',
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gdc_npstockcompromvtasespecialespendentregaaclientesUpdate = (
  request,
  response,
) => {
  ...
  pool.query(
    'INSERT INTO public."gdc_npstockcomprom-vtasespeciales-pendentregaaclientes"(id, "Cod_NP", "Nombre_NP") VALUES ($1, $2, $3) ON CONFLICT (id) DO UPDATE SET "Cod_NP" = $2, "Nombre_NP" = $3;',
    [id, Cod_NP, Nombre_NP],
    (error, results) => {
      if (error) {
        throw error;
...
const gdc_npstockcompromvtasespecialespendentregaaclientesDelete = (
  request,
  response,
) => {
  const id = parseInt(request.params.id);
...
const gdc_chapastiposqueladefinen = (request, response) => {
  pool.query(
    "SELECT * FROM public.gdc_chapastiposqueladefinen",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gdd_clientes_distribuciones = (request, response) => {
  pool.query(
    "SELECT * FROM public.gdd_clientes_distribuciones",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gdd_clientes_distribucionesCreate = (request, response) => {
  const {
    cod_cliente,
    nombre_cliente,
    perfilcomercial_cliente,
    domicilio_cliente,
    zonas_distribucion_cliente,
    nro_whatsapp_cliente,
    rubros_ventas,
    habilitado,
    localidad_cliente,
    provincia_cliente,
    nombre_zonas_distribucion_cliente,
    contacto,
  } = request.body;
  pool.query(
...
const gdd_parametros_distribuciones = (request, response) => {
  pool.query(
    "SELECT * FROM public.gdd_parametros_distribuciones",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gdd_parametros_distribucionesCreate = (request, response) => {
  const {
    id,
    perfil_comercial_defecto,
    dto_financiero,
    cant_dias_desde_cambios_precio,
    cant_modif_minimo,
  } = request.body;
  pool.query(
...
const simulador_tiposdecomprobantes = async () => {
  try {
    const { rows } = await pool.query(
      "SELECT * FROM public.simulador_cobranzas_tipos_de_comprobantes",
    );
    return rows;
  } catch (error) {
...
const gdc_npaconsiderar = (request, response) => {
  pool.query(
    "SELECT * FROM gdc_npaconsiderar ORDER BY id ASC",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gdc_deposanoconsiderarpstockfisico = (request, response) => {
  pool.query(
    "SELECT * FROM gdc_deposanoconsiderarpstockfisico ORDER BY id ASC",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gdc_articuloscontrol = (request, response) => {
  pool.query(
    "SELECT * FROM gdc_articulos_control ORDER BY id ASC",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gdc_tiposremitosvtas = (request, response) => {
  pool.query(
    "SELECT * FROM gdc_tiposremitosvtas ORDER BY id ASC",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gdc_tiposcompstock = (request, response) => {
  pool.query(
    "SELECT * FROM gdc_tiposcompstock ORDER BY id ASC",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gde_comprobantestock = (request, response) => {
  pool.query(
    "SELECT * FROM gde_comprobantestock ORDER BY id ASC",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gde_comprobantestockCreate = (request, response) => {
  ...
  pool.query(
    "INSERT INTO gde_comprobantestock(cod_comp, nombre_comp) VALUES ($1, $2) RETURNING *",
    [cod_comp, nombre_comp],
    (error, results) => {
      if (error) {
        throw error;
...
const gde_comprobantestockUpdate = (request, response) => {
  ...
  pool.query(
    'INSERT INTO gde_comprobantestock(id, "cod_comp", "nombre_comp") VALUES ($1, $2, $3) ON CONFLICT (id) DO UPDATE SET "cod_comp" = $2, "nombre_comp" = $3;',
    [id, cod_comp, nombre_comp],
    (error, results) => {
      if (error) {
        throw error;
...
const gde_comprobantestockDelete = (request, response) => {
  const id = parseInt(request.params.id);
  pool.query(
    "DELETE FROM gde_comprobantestock WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const gde_deposanoconsiderar = (request, response) => {
  pool.query(
    "SELECT * FROM gde_deposanoconsiderar ORDER BY id ASC",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gde_deposanoconsiderarCreate = (request, response) => {
  ...
  pool.query(
    "INSERT INTO gde_deposanoconsiderar(cod_depos, nombre_depos) VALUES ($1, $2) RETURNING *",
    [cod_depos, nombre_depos],
    (error, results) => {
      if (error) {
        throw error;
...
const gde_deposanoconsiderarUpdate = (request, response) => {
  ...
  pool.query(
    'INSERT INTO gde_deposanoconsiderar(id, "cod_depos", "nombre_depos") VALUES ($1, $2, $3) ON CONFLICT (id) DO UPDATE SET "cod_depos" = $2, "nombre_depos" = $3;',
    [id, cod_depos, nombre_depos],
    (error, results) => {
      if (error) {
        throw error;
...
const gde_deposanoconsiderarDelete = (request, response) => {
  const id = parseInt(request.params.id);
  pool.query(
    "DELETE FROM gde_deposanoconsiderar WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const gde_npaconsiderar = (request, response) => {
  pool.query(
    "SELECT * FROM gde_npaconsiderar ORDER BY id ASC",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gde_npaconsiderarCreate = (request, response) => {
  ...
  pool.query(
    "INSERT INTO gde_npaconsiderar(cod_comp, nombre_comp) VALUES ($1, $2) RETURNING *",
    [cod_comp, nombre_comp],
    (error, results) => {
      if (error) {
        throw error;
...
const gde_npaconsiderarUpdate = (request, response) => {
  ...
  pool.query(
    'INSERT INTO gde_npaconsiderar(id, "cod_comp", "nombre_comp") VALUES ($1, $2, $3) ON CONFLICT (id) DO UPDATE SET "cod_comp" = $2, "nombre_comp" = $3;',
    [id, cod_comp, nombre_comp],
    (error, results) => {
      if (error) {
        throw error;
...
const gde_npaconsiderarDelete = (request, response) => {
  const id = parseInt(request.params.id);
  pool.query(
    "DELETE FROM gde_npaconsiderar WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
const gde_recepcionproveedoraconsiderar = (request, response) => {
  pool.query(
    "SELECT * FROM gde_recepcionproveedoraconsiderar ORDER BY id ASC",
    (error, results) => {
      if (error) {
        throw error;
      }
...
const gde_recepcionproveedoraconsiderarCreate = (request, response) => {
  ...
  pool.query(
    "INSERT INTO gde_recepcionproveedoraconsiderar(cod_comp, nombre_comp) VALUES ($1, $2) RETURNING *",
    [cod_comp, nombre_comp],
    (error, results) => {
      if (error) {
        throw error;
...
const gde_recepcionproveedoraconsiderarUpdate = (request, response) => {
  ...
  pool.query(
    'INSERT INTO gde_recepcionproveedoraconsiderar(id, "cod_comp", "nombre_comp") VALUES ($1, $2, $3) ON CONFLICT (id) DO UPDATE SET "cod_comp" = $2, "nombre_comp" = $3;',
    [id, cod_comp, nombre_comp],
    (error, results) => {
      if (error) {
        throw error;
...
const gde_recepcionproveedoraconsiderarDelete = (request, response) => {
  const id = parseInt(request.params.id);
  pool.query(
    "DELETE FROM gde_recepcionproveedoraconsiderar WHERE id = $1",
    [id],
    (error, results) => {
      if (error) {
        throw error;
...
async function actualizarConfigCron({
  cronSchedule,
  timezone,
  usuario = "admin",
}) {
